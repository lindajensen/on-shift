          ...
          <article className="job-card">
            ...
            <div className="job-card__meta">
              <div className="job-card__meta-item">
                <Clock size={14} />
                <p className="job-card__meta-text">Idag kl. 17:00 - 22:00</p>
              </div>
              <div className="job-card__meta-item">
                <MapPin size={14} />
            ...
            <div className="job-card__footer-meta">
              ...
              <p className="job-card__published">Publicerad: Idag kl. 14:00</p>
            </div>
        ...
        <li className="job-list__item">
          <article className="job-card">
            ...
            <div className="job-card__meta">
              <div className="job-card__meta-item">
                <Clock size={14} />
                <p className="job-card__meta-text">Lördag kl. 11:00 - 16:00</p>
              </div>
              <div className="job-card__meta-item">
                <MapPin size={14} />
            ...
            <div className="job-card__footer-meta">
              ...
              <p className="job-card__published">Publicerad: Igår kl. 11:00</p>
            </div>
